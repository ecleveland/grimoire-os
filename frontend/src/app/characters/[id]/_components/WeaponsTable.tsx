      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-gray-300 dark:border-gray-600">
            ...
            <th className="text-left text-xs font-medium text-gray-500 dark:text-gray-400 pb-1">Atk Bonus / DC</th>
            <th className="text-left text-xs font-medium text-gray-500 dark:text-gray-400 pb-1">Damage & Type</th>
            <th className="text-left text-xs font-medium text-gray-500 dark:text-gray-400 pb-1">Notes</th>
          </tr>
        </thead>
        <tbody>
          {weapons.map((weapon) => (
            <tr key={weapon.name} className="border-b border-gray-100 dark:border-gray-700 last:border-0">
              ...
              <td className="py-1.5 text-gray-700 dark:text-gray-300">{weapon.damage} {weapon.damageType}</td>
