          ...
          <div key={race.id} className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            {expanded.has(race.id) && (
              <div className="px-4 pb-4 border-t border-gray-100 dark:border-gray-700 pt-3 space-y-3">
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300">Ability Bonuses</h3>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">{race.languages.join(', ')}</p>
                </div>
              </div>
            )}
          </div>
