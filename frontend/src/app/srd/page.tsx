...
const categories = [
  {
    ...
    title: 'Search',
    description:
      'Find spells, feats, items, classes, and class/race/background features in one place. Filter by class, level, school, category, rarity, prerequisite, or source.',
  },
  {
    href: '/srd/monsters',
    title: 'Monsters',
  ...
  },
  {
    href: '/srd/classes',
    title: 'Classes',
    description: 'View class features, hit dice, and proficiencies.',
  },
  {
    href: '/srd/races',
    title: 'Races',
    description: 'Explore racial traits, ability bonuses, and languages.',
  },
];
