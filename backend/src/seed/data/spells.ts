export const srdSpells = [
  ...
  },
  {
    ...
    description:
      'Objects animate at your command. Choose a number of nonmagical objects within range that aren’t being worn or carried, aren’t fixed to a surface, and aren’t Gargantuan. The maximum number of objects is equal to your spellcasting ability modifier; for this number, a Medium or smaller target counts as one object, a Large target counts as two, and a Huge target counts as three. Each target animates, sprouts legs, and becomes a Construct that uses the Animated Object stat block; this creature is under your control until the spell ends or until it is reduced to 0 Hit Points. Each creature you make with this spell is an ally to you and your allies. In combat, it shares your Initiative count and takes its turn immediately after yours. Until the spell ends, you can take a Bonus Action to mentally command any creature you made with this spell if the creature is within 500 feet of you (if you control multiple creatures, you can command any of them at the same time, issuing the same command to each one). If you issue no commands, the creature takes the Dodge action and moves only to avoid harm. When the creature drops to 0 Hit Points, it reverts to its object form, and any remaining damage carries over to that form. Animated Object Huge or Smaller Construct, Unaligned AC 15 HP 10 (Medium or smaller), 20 (Large), 40 (Huge) Speed 30 ft. STR 16 (+3), DEX 10 (+0), CON 10 (+0), INT 3 (-4), WIS 3 (-4), CHA 1 (-5) Immunities: Poison, Psychic; Charmed, Exhaustion, Frightened, Paralyzed, Poisoned Senses: Blindsight 30 ft.; Passive Perception 6 Languages: Understands the languages you know CR: None (XP 0; PB equals your Proficiency Bonus) Actions Slam. Melee Attack Roll: Bonus equals your spell attack modifier, reach 5 ft. Hit: Force damage equal to 1d4 + 3 (Medium or smaller), 2d6 + 3 + your spellcasting ability modifier (Large), or 2d12 + 3 + your spellcasting ability modifier (Huge).',
  ...
  },
  {
    ...
    duration: 'Instantaneous',
    description:
      'You receive an omen from an otherworldly entity about the results of a course of action that you plan to take within the next 30 minutes. The GM chooses the omen from the Omens table. Omens Omen For Results That Will Be … Weal Good',
  ...
  },
  {
    ...
    duration: 'Until dispelled',
    description: `A flame springs from an object that you touch. The effect casts Bright Light in a 20-foot radius and Dim Light for an additional 20 feet. It looks like a regular flame, but it creates no heat and doesn't use oxygen. The flame can be covered or hidden, but not smothered or quenched.`,
    classes: ['Cleric', 'Druid', 'Wizard'],
    ritual: false,
    concentration: false,
  },
  ...
  },
  {
    ...
    duration: 'Concentration, up to 1 minute',
    description:
      'You touch one willing creature, and choose Acid, Cold, Fire, Lightning, or Poison. Until the spell ends, the target can use a Magic action to exhale a 15-foot Cone. Each creature in the Cone makes a Dexterity saving throw, taking 3d6 damage of the chosen type on a failed save or half as much damage on a successful one.',
    higherLevels:
  ...
  },
  {
    ...
    components: 'V, S',
    duration: 'Instantaneous',
    description: `You summon an otherworldly being that appears as a loyal steed in an unoccupied space of your choice within range. This creature uses the Otherworldly Steed stat block. If you already have a steed from this spell, the steed is replaced by the new one. The steed resembles a Large, rideable animal of your choice, such as a horse, a camel, a dire wolf, or an elk. Whenever you cast the spell, choose the steed’s creature type—Celestial, Fey, or Fiend— which determines certain traits in the stat block. Combat. The steed is an ally to you and your allies. In combat, it shares your Initiative count, and it functions as a controlled mount while you ride it (as defined in the rules on mounted combat). If you have the Incapacitated condition, the steed takes its turn immediately after yours and acts independently, focusing on protecting you. Disappearance of the Steed. The steed disappears if it drops to 0 Hit Points or if you die. When it disappears, it leaves behind anything it was wearing or carrying. If you cast this spell again, you decide whether you summon the steed that disappeared or a different one. Otherworldly Steed Large Celestial, Fey, or Fiend (Your Choice), Neutral AC 10 + 1 per spell level HP 5 + 10 per spell level (the steed has a number of Hit Dice [d10s] equal to the spell's level) Speed 60 ft., Fly 60 ft. (requires level 4+ spell) STR 18 (+4), DEX 12 (+1), CON 14 (+2), INT 6 (-2), WIS 12 (+1), CHA 8 (-1) Senses: Passive Perception 11 Languages: Telepathy 1 mile (only with you) Actions Otherworldly Slam. Melee Attack Roll: your spell attack modifier, reach 5 ft. Hit: 1d8 + 4 + the spell's level Radiant damage (Celestial), Psychic damage (Fey), or Necrotic damage (Fiend). Fell Glide (level 4+ spell). The steed and its rider gain a Fly Speed equal to the steed's Speed for 1 minute. Otherworldly Steed Large Celestial, Fey, or Fiend (Your Choice), Neutral AC 10 + 1 per spell level HP 5 + 10 per spell level (the steed has a number of Hit Dice [d10s] equal to the spell's level) Speed 60 ft., Fly 60 ft. (requires level 4+ spell) STR 18 (+4), DEX 12 (+1), CON 14 (+2), INT 6 (-2), WIS 12 (+1), CHA 8 (-1) Senses: Passive Perception 11 Languages: Telepathy 1 mile (works only with you) CR: None (XP 0; PB equals your Proficiency Bonus) Traits Life Bond. When you regain Hit Points from a level 1+ spell, the steed regains the same number of Hit Points if you're within 5 feet of it. Actions Otherworldly Slam. Melee Attack Roll: Bonus equals your spell attack modifier, reach 5 ft. Hit: 1d8 plus the spell's level of Radiant (Celestial), Psychic (Fey), or Necrotic (Fiend) damage. Bonus Actions Fell Glare (Fiend Only; Recharges after a Long Rest). Wisdom Saving Throw: DC equals your spell save DC, one creature within 60 feet the steed can see. Failure: The target has the Frightened condition until the end of your next turn. Fey Step (Fey Only; Recharges after a Long Rest). The steed teleports, along with its rider, to an unoccupied space of your choice up to 60 feet away from itself. Healing Touch (Celestial Only; Recharges after a Long Rest). One creature within 5 feet of the steed regains a number of Hit Points equal to 2d8 plus the spell's level.`,
  ...
  },
  {
    ...
    higherLevels:
      'Using a Higher-Level Spell Slot. The damage increases by 1d6 for each spell slot level above 2. Flesh to Stone',
    classes: ['Druid', 'Sorcerer', 'Wizard'],
    ritual: false,
    concentration: true,
  },
  ...
  },
  {
    ...
    higherLevels:
      'Using a Higher-Level Spell Slot. The damage of an explosive rune increases by 1d8 for each spell slot level above 3. If you create a spell glyph, you can store any spell of up to the same level as the spell slot you use for the Glyph of Warding. A creature you touch has the Invisible condition until the spell ends.',
    classes: ['Bard', 'Cleric', 'Wizard'],
    ritual: false,
    concentration: false,
  },
  {
    ...
    duration: '24 hours',
    description:
      'Ten berries appear in your hand and are infused with magic for the duration. A creature can use a Bonus Action to eat one berry. Eating a berry restores 1 Hit Point, and the berry provides enough nourishment to sustain a creature for one day. Uneaten berries disappear when the spell ends.',
    classes: ['Druid', 'Ranger'],
    ritual: false,
    concentration: false,
  },
  ...
  },
  {
    ...
    duration: '8 hours',
    description:
      'A Large spectral guardian appears and hovers for the duration in an unoccupied space that you can see within range. The guardian occupies that space and is indistinct except for a gleaming sword and shield emblazoned with the symbol of your deity. Any creature hostile to you that moves to a space within 10 feet of the guardian for the first time on a turn makes a Dexterity saving throw, taking 20 Radiant damage on a failed save or half as much damage on a successful one. The guardian vanishes when it has dealt a total of 60 damage.',
    classes: ['Cleric'],
    ritual: false,
    concentration: false,
  },
  {
    ...
    duration: '24 hours',
    description:
      'You create a ward that protects up to 2,500 square feet of floor space. The warded area can be up to 20 feet tall, and you shape it as one 50-foot square, one hundred 5-foot squares, or twenty-five 10-foot squares (the warded squares must be contiguous). When you cast this spell, you can specify individuals that are unaffected by the spell’s effects. You can also specify a password that, when spoken aloud within 5 feet of the warded area, makes the speaker immune to its effects. The spell creates the following effects within the warded area. • Corridors. Fog fills all the warded corridors, making them Heavily Obscured. In addition, at each intersection or branching passage offering a choice of direction, there is a 50 percent chance that a creature other than you believes it is going in the opposite direction from the one it chooses. • Doors. All doors in the warded area are magically locked, as if sealed by an Arcane Lock spell. In addition, you can cover up to ten doors with an illusion, making them appear as plain sections of wall. • Stairs. Webs fill all stairs in the warded area from top to bottom, as in the Web spell. These strands regrow in 10 minutes if they are destroyed while Guards and Wards lasts. • Other Spell Effect. Place one of the following spell effects in each of the warded area’s spaces: • Dancing Lights in four corridors, with a simple program that the lights repeat • Magic Mouth in two locations • Stinking Cloud in two locations (the vapors return within 10 minutes if dispersed while Guards and Wards lasts) • Gust of Wind in one corridor or room (the wind blows continuously while the spell lasts) • Suggestion in one 5-foot square; any creature that enters that square receives the Suggestion mentally. The whole warded area radiates magic. Dispel Magic cast on a specific effect, if successful, removes only that effect. You can create a permanently guarded and warded structure by casting this spell there every day for a year.',
    classes: ['Bard', 'Wizard'],
    ritual: false,
    concentration: false,
  },
  ...
  },
  {
    ...
    duration: 'Instantaneous',
    description: `Name or describe a famous person, place, or object. The spell brings to your mind a brief summary of the significant lore about what you named. The lore might consist of important details, tales, or even secret information that has never been widely known. If the thing you named isn't of legendary importance, you gain no information. The more information you already have about the thing, the more precise and detailed the information you receive is. The information you learn is accurate but might be couched in figurative language or archaic terms.`,
    classes: ['Bard', 'Cleric', 'Wizard'],
    ritual: false,
    concentration: false,
  },
  ...
  },
  {
    ...
    duration: 'Concentration, up to 1 day',
    description:
      'For the duration, the willing creature you touch has Resistance to one damage type of your choice: Acid, Cold, Fire, Lightning, or Thunder. Protection from Evil and Good',
    classes: ['Bard', 'Wizard'],
    ritual: false,
    concentration: true,
  },
  ...
  },
  {
    ...
    duration: 'Instantaneous',
    description:
      'You touch a dead Humanoid or a piece of one. If the creature has been dead no longer than 10 days, the spell forms a new body for it and calls the soul to enter that body. Roll 1d10 and consult the table below to determine the body’s species, or the GM chooses another playable species. 1d10',
    classes: ['Druid'],
    ritual: false,
    concentration: false,
  },
  ...
  },
  {
    ...
    higherLevels:
      'Cantrip Upgrade. The damage increases by 1d8 when you reach levels 5 (2d8), 11 (3d8), and 17 (4d8). Reverse Gravity',
    classes: ['Druid', 'Sorcerer', 'Wizard'],
    ritual: false,
    concentration: true,
  },
  {
    ...
    duration: 'Instantaneous',
    description: `You touch a creature that has died within the last minute. That creature revives with 1 Hit Point. This spell can't revive a creature that has died of old age, nor can it restore any missing body parts.`,
    classes: ['Cleric', 'Druid', 'Paladin', 'Ranger'],
    ritual: false,
    concentration: false,
  },
  {
    ...
    duration: '1 hour',
    description: `You touch a rope. One end of it rises into the air until the whole rope hangs perpendicular to the ground. At the upper end of the rope, an Invisible entrance opens to an extradimensional space that lasts until the spell ends. The extradimensional space can be reached by climbing to the top of the rope. The space can hold as many as eight Medium or smaller creatures. The rope can be pulled into the space, making the rope disappear from view outside the space. Attacks and spells can't cross through the entrance into or out of the extradimensional space, but those inside can see out of it as if through a 3-foot-by-5-foot window centered on the rope. Anything inside the extradimensional space drops out when the spell ends.`,
    classes: ['Wizard'],
    ritual: false,
    concentration: false,
  },
  ...
  },
  {
    ...
    duration: 'Instantaneous',
    description:
      'You hurl three fiery rays. You can hurl them at one target or at several. Make a ranged spell attack for each ray. On a hit, the target takes 2d6 Fire damage.',
    higherLevels:
  ...
  },
  {
    ...
    duration: 'Concentration, up to 10 minutes',
    description: `You can see and hear a particular creature you choose that is on the same plane of existence as you. The target makes a Wisdom saving throw, which is modified (see the tables below) by how well you know the target and the sort of physical connection you have to it. The target doesn't know what it is making the save against, only that it feels uneasy. Your Knowledge of the Target Is... | Save Modifier Secondhand (heard of the target) | +5 Firsthand (met the target) | +0 Extensive (know the target well) | -5 You Have the Target's... | Save Modifier Picture or other likeness | -2 Garment or other possession | -4 Body part, lock of hair, or bit of nail | -10 On a successful save, the target isn't affected, and you can't use this spell on it again for 24 hours. On a failed save, the spell creates an Invisible, intangible sensor within 10 feet of the target. You can see and hear through the sensor as if you were there. The sensor moves with the target, remaining within 10 feet of it for the duration. If something can see the sensor, it appears as a luminous orb about the size of your fist. Instead of targeting a creature, you can choose a location you have seen before as the target of this spell. When you do, the sensor appears at that location and doesn't move.`,
    classes: ['Bard', 'Cleric', 'Druid', 'Warlock', 'Wizard'],
    ritual: false,
    concentration: true,
  },
  ...
  },
  {
    ...
    duration: 'Concentration, up to 1 minute',
    description:
      'You launch a beam of brilliant light in a 5-foot-wide, 60-foot-long Line. Each creature in the Line makes a Constitution saving throw. On a failed save, a creature takes 6d8 Radiant damage and has the Blinded condition until the start of your next turn. On a successful save, it takes half as much damage only. Until the spell ends, you can take a Magic action on your later turns to create a new Line of radiance. For the duration, a mote of brilliant radiance shines above your hand. It sheds Bright Light in a 30-foot radius and Dim Light for an additional 30 feet. The light is sunlight.',
  ...
  },
  {
    ...
    duration: 'Until dispelled or triggered',
    description: `You inscribe a harmful glyph either on a surface (such as a section of floor or wall) or within an object that can be closed (such as a book or chest). The glyph can cover an area no larger than 10 feet in diameter. If you choose an object, it must remain in place; if it is moved more than 10 feet from where you cast this spell, the glyph breaks, and the spell ends without being triggered. The glyph is nearly Invisible, requiring an Intelligence (Investigation) check against your spell save DC to find. You decide what triggers the glyph when you cast the spell. For glyphs inscribed on a surface, common triggers include touching or stepping on the glyph, removing another object covering it, approaching within a certain distance of it, or manipulating the object that holds it. For glyphs inscribed within an object, common triggers include opening that object, approaching within a certain distance of it, or seeing or reading the glyph. You can refine the trigger so that only creatures of certain types activate it. You can also set conditions for creatures that don't trigger the glyph, such as those who say a certain password. When you inscribe the glyph, choose one of the options below for its effect. Once triggered, the glyph glows, filling a 60-foot-radius Sphere with Dim Light for 10 minutes, after which time the spell ends. Each creature in the Sphere when the glyph activates is targeted by its effect, as is a creature that enters the Sphere for the first time on a turn or ends its turn there. A creature is targeted only once per turn. Death. Each target makes a Constitution saving throw, taking 10d10 Necrotic damage on a failed save or half as much damage on a successful one. Discord. Each target makes a Constitution saving throw. On a failed save, a target argues with other creatures for 1 minute. During this time, it is incapable of meaningful communication and has Disadvantage on attack rolls and ability checks. Fear. Each target makes a Wisdom saving throw and has the Frightened condition for 1 minute on a failed save. While Frightened, the target drops whatever it is holding and must move at least 30 feet away from the glyph on each of its turns, if able. Hopelessness. Each target makes a Charisma saving throw. On a failed save, the target has the Incapacitated condition and does nothing for 1 minute. The effect ends on the target early if the target takes damage or if someone takes an action to shake it out of its stupor. Insanity. Each target makes an Intelligence saving throw. On a failed save, the target goes insane for 1 minute. An insane creature can't take actions, can't understand what other creatures say, can't read, and speaks only in gibberish. The GM controls the creature's movement, which is erratic. Pain. Each target makes a Constitution saving throw and has the Incapacitated condition for 1 minute on a failed save. Sleep. Each target makes a Wisdom saving throw and has the Unconscious condition for 10 minutes on a failed save. A creature awakens if it takes damage or if someone uses an action to shake or slap it awake. Stunning. Each target makes a Wisdom saving throw and has the Stunned condition for 1 minute on a failed save.`,
  ...
  },
  {
    ...
    duration: 'Instantaneous',
    description:
      'This spell instantly transports you and up to eight willing creatures that you can see within range, or a single object that you can see within range, to a destination you select. If you target an object, it must be Large or smaller, and it can’t be held or carried by an unwilling creature. The destination you choose must be known to you, and it must be on the same plane of existence as you. Your familiarity with the destination determines whether you arrive there successfully. The GM rolls 1d100 and consults the Teleportation Outcome table and the explanations after it. Teleportation Outcome Mishap Similar Area Off Target On Target Permanent circle — — — 01–00 Linked object — — — 01–00 Very familiar 01–05 06–13 14–24 25–00 Seen casually 01–33 34–43 44–53 54–00 Viewed once or described 01–43 44–53 54–73 74–00 False destination 01–50 51–00 — —',
    classes: ['Bard', 'Sorcerer', 'Wizard'],
    ritual: false,
    concentration: false,
  },
