export const srdItems = [
  ...
  },
  {
    ...
    cost: '25 gp',
    weight: 2,
    description: 'A small bow suited for use in tight spaces or by smaller creatures.',
    damage: '1d6 piercing',
  ...
  },
  {
    ...
    category: 'Armor',
    description:
      'You have a bonus to Armor Class while wearing this armor. The bonus is determined by its rarity. Rarity by variant: +1: Rare, +2: Very Rare, +3: Legendary.',
    rarity: 'Varies',
    requiresAttunement: false,
    isMagic: true,
    properties: ['Any Light, Medium, or Heavy'],
  },
  {
    name: 'Armor of Invulnerability',
    category: 'Armor',
    description:
      'You have Resistance to Bludgeoning, Piercing, and Slashing damage while you wear this armor. Metal Shell. You can take a Magic action to give yourself Immunity to Bludgeoning, Piercing, and Slashing damage for 10 minutes or until you are x- no longer wearing the armor. Once this property is used, it can’t be used again until the next dawn.',
    rarity: 'Legendary',
    requiresAttunement: true,
    isMagic: true,
  ...
  },
  {
    ...
    category: 'Armor',
    description:
      'You have Resistance to one type of damage while you wear this armor. The GM chooses the type or determines it randomly by rolling on the following table. 1d10 Damage Type 1d10 Damage Type 1 Acid 6 Necrotic 2 Cold 7 Poison 3 Fire 8 Psychic 4 Force 9 Radiant 5 Lightning 10 Thunder Down swim. Legs retract, reducing the apparatus’s Speed and Swim Speed to 0 and making it unable to benefit from bonuses to speed. Forward window shutter closes. Side window shutters close (two per side). The claws retract. tack: Each extended claw makes the following melee attack: damage. +8 to hit, reach 5 ft. Hit: The target has the Grappled condition (escape DC 15). ts The apparatus walks or swims backward provided its legs are extended. The apparatus turns 90 degrees clockwise provided its legs are extended. radius The light turns off. quid. The apparatus rises up to 20 feet if it’s in liquid. The rear hatch closes and seals.',
    rarity: 'Rare',
    requiresAttunement: true,
    isMagic: true,
    properties: ['Any Light, Medium, or Heavy'],
  ...
  },
  {
    ...
    category: 'Wondrous Item',
    description:
      'This bag made from gray, rust, or tan cloth appears empty. Reaching inside the bag, however, reveals the presence of a small, fuzzy object. You can take a Magic action to pull the fuzzy object from the bag and throw it up to 20 feet. When the object lands, it transforms into a creature you determine by rolling on the table that corresponds to the bag’s color. See “Monsters” for the creature’s stat block. The creature vanishes at the next dawn or when it is reduced to 0 Hit Points. The creature is Friendly to you and your allies, and it acts immediately after you on your Initiative count. You can take a Bonus Action to command how the creature moves and what action it takes on its next turn, such as attacking an enemy. In the absence of such orders, the creature acts in a fashion appropriate to its nature. Once three fuzzy objects have been pulled from the bag, the bag can’t be used again until the next dawn. Gray Bag of Tricks 1d8 Creature 1d8 Creature 1 Weasel 5 Panther 2 Giant Rat 6 Giant Badger 3 Badger 7 Dire Wolf 4 Boar 8 Giant Elk Rust Bag of Tricks 1d8 Creature 1d8 Creature 1 Rat 5 Giant Goat 2 Owl 6 Giant Boar 3 Mastiff 7 Lion 4 Goat 8 Brown Bear Tan Bag of Tricks 1d8 Creature 1d8 Creature 1 Jackal 5 Black Bear 2 Ape 6 Giant Weasel 3 Baboon 7 Giant Hyena 4 Axe Beak 8 Tiger Variants: Gray Bag of Tricks: Contains: Weasel, Giant Rat, Badger, Boar, Panther, Giant Badger, Dire Wolf, Giant Elk. | Rust Bag of Tricks: Contains: Rat, Owl, Mastiff, Goat, Giant Goat, Giant Boar, Lion, Brown Bear. | Tan Bag of Tricks: Contains: Jackal, Ape, Baboon, Axe Beak, Black Bear, Giant Weasel, Giant Hyena, Tiger.',
    rarity: 'Uncommon',
    requiresAttunement: false,
    isMagic: true,
  },
  ...
  },
  {
    ...
    category: 'Wondrous Item',
    description:
      'While wearing this belt, your Strength changes to a score granted by the belt. The type of giant determines the score (see the table below). The item has no effect on you if your Strength without the belt is equal to or greater than the belt’s score. Belt Str. Rarity Belt of Giant Strength (hill) 21 Rare Belt of Giant Strength (frost or 23 Very Rare stone) Belt of Giant Strength (fire) 25 Very Rare Belt of Giant Strength (cloud) 27 Legendary Belt of Giant Strength (storm) 29 Legendary Variants: Belt of Giant Strength (hill) (Rare): Your Strength changes to 21. | Belt of Giant Strength (frost or stone) (Very Rare): Your Strength changes to 23. | Belt of Giant Strength (fire) (Very Rare): Your Strength changes to 25. | Belt of Giant Strength (cloud) (Legendary): Your Strength changes to 27. | Belt of Giant Strength (storm) (Legendary): Your Strength changes to 29.',
    rarity: 'Varies',
    requiresAttunement: true,
    isMagic: true,
  },
  {
    ...
    requiresAttunement: true,
    isMagic: true,
    properties: ['Battleaxe, Greataxe, or Halberd'],
  },
  {
  ...
  },
  {
    ...
    category: 'Wondrous Item',
    description:
      'While you wear this cloak, it magically projects an illusion that makes you appear to be standing in a place near your actual location, causing any creature to have Disadvantage on attack rolls against you. If you take damage, the property ceases to function until the start of your next turn. This prop- erty is suppressed while your Speed is 0.',
    rarity: 'Rare',
    requiresAttunement: true,
    isMagic: true,
  },
  ...
  },
  {
    ...
    requiresAttunement: true,
    isMagic: true,
    properties: ['3 charges (recharges dawn, 1d3)'],
  },
  {
  ...
  },
  {
    ...
    category: 'Weapon',
    description:
      'You can take a Bonus Action to toss this magic weapon into the air. When you do so, the weapon begins to hover, flies up to 30 feet, and attacks one creature of your choice within 5 feet of itself. The weapon uses your attack roll and adds your ability modifier to damage rolls. While the weapon hovers, you can take a Bonus Action to cause it to fly up to 30 feet to another spot within 30 feet of you. As part of the same Bonus Ac- tion, you can cause the weapon to attack one crea- ture within 5 feet of the weapon. After the hovering weapon attacks for the fourth time, it flies back to you and tries to return to your hand. If you have no hand free, the weapon falls to the ground in your space. If the weapon has no un- obstructed path to you, it moves as close to you as it can and then falls to the ground. It also ceases to hover if you grasp it or are more than 30 feet away from it.',
    rarity: 'Very Rare',
    requiresAttunement: true,
    isMagic: true,
    properties: ['Greatsword, Longsword, Rapier, Scimitar, or Shortsword'],
  },
  {
  ...
  },
  {
    ...
    category: 'Wondrous Item',
    description:
      'This box contains a set of cards. A full deck has 34 cards: 32 depicting specific creatures and two with a mirrored surface. A deck found as treasure is usually missing 1d20 − 1 cards. The magic of the deck functions only if its cards are drawn at random. You can take a Magic action to draw a card at random from the deck and throw it to the ground at a point within 30 feet of yourself. An illusion of a creature, determined by rolling on the Deck of Illusions table, forms over the thrown card and remains until dispelled. The illusory crea- ture created by the card looks and behaves like a real creature of its kind, except that it can do no harm. While you are within 120 feet of the illusory creature and can see it, you can take a Magic action to move it anywhere within 30 feet of its card. Any physical interaction with the illusory crea- ture reveals it to be false, because objects pass through it. A creature that takes a Study action to visually inspect the illusory creature identifies it as an illusion with a successful DC 15 Intelligence (In- vestigation) check. The illusion lasts until its card is moved or the illusion is dispelled (using a Dispel Magic spell or a similar effect). When the illusion ends, the image on its card disappears, and that card can’t be used again. Deck of Illusions 1d100 Illusion* 01–03 Adult Red Dragon 04–06 Archmage 07–09 Assassin 10–12 Bandit Captain 13–15 Basilisk 16–18 Berserker 19–21 Bugbear Warrior 22–24 Cloud Giant 25–27 Druid 28–30 Erinyes 31–33 Ettin 34–36 Fire Giant 37–39 Frost Giant 40–42 Gnoll Warrior 43–45 Goblin Warrior 46–48 Guardian Naga 49–51 Hill Giant 52–54 Hobgoblin Warrior 55–57 Incubus 58–60 Iron Golem 61–63 Knight 64–66 Kobold Warrior 67–69 Lich 70–72 Medusa 73–75 Night Hag 76–78 Ogre 79–81 Oni 1d100 Illusion* 82–84 Priest 85–87 Succubus 88–90 Troll 91–93 Veteran Warrior 94–96 Wyvern 97–00 The card drawer *Stat blocks for these creatures (except the card drawer “Monsters.”',
    rarity: 'Uncommon',
    requiresAttunement: false,
    isMagic: true,
  },
  ...
  },
  {
    ...
    category: 'Wondrous Item',
    description:
      'An orb is an etched crystal globe about 10 inches in diameter. When used, it grows to about 20 inches in diameter, and mist swirls inside it. ) appear in While attuned to an orb, you can take a Magic action to peer into the orb’s depths. You must then make a DC 15 Charisma saving throw. On a successful save, you control the orb for as long as you remain attuned to it. On a failed save, the orb imposes the Charmed condition on you for as long as you remain attuned to it. While you are Charmed by the orb, you can’t voluntarily end your Attunement to it, and the orb casts Suggestion on you at will (save DC 18), urging you to work toward the evil ends it desires. The dragon essence within the orb might want many things: the annihilation of a particular society or organization, freedom from the orb, to spread suffering in the world, to advance the worship of Tiamat, or something else the GM decides. Spells. The orb has 7 charges and regains 1d4 + 3 expended charges daily at dawn. If you control the orb, you can cast one of the spells on the following table from it. The table indicates how many charges you must expend to cast the spell. Spell Charge Cost Cure Wounds (level 9 version) 4 Daylight 1 Death Ward 2 Detect Magic 0 Scrying (save DC 18) 3 Call Dragons. While you control the orb, you can take a Magic action to cause the orb to issue a telepathic call that extends in all directions for 40 miles. Chromatic dragons in range feel compelled to come to the orb as soon as possible by the most direct route. Dragon deities such as Tiamat are unaffected by this call. Chromatic dragons drawn to the orb might be Hostile toward you for compelling them against their will. Once you have used this property, it can’t be used again for 1 hour. Destroying an Orb. A Dragon Orb has AC 20 and is destroyed if it takes damage from a +3 Weapon or a Disintegrate spell. Nothing else can harm it. Spells: Cure Wounds (level 9 version) (4 charges), Daylight (1 charges), Death Ward (2 charges), Detect Magic.',
    rarity: 'Artifact',
    requiresAttunement: true,
    isMagic: true,
    properties: ['7 charges (recharges dawn, 1d4+3)'],
  },
  {
  ...
  },
  {
    ...
    requiresAttunement: false,
    isMagic: true,
    properties: ['Any Simple or Martial'],
  },
  {
  ...
  },
  {
    ...
    requiresAttunement: false,
    isMagic: true,
    properties: ['Half Plate Armor or Plate Armor'],
  },
  {
    ...
    requiresAttunement: true,
    isMagic: true,
    properties: ['Warhammer', 'Attunement: Dwarf or a Creature Attuned to a Belt of Dwarvenkind'],
  },
  {
  ...
  },
  {
    ...
    category: 'Potion',
    description:
      'When you drink this potion, you are cured of all magical contagions. In addition, the following con- ditions end on you: Blinded, Deafened, Paralyzed, and Poisoned. The clear, red liquid has tiny bubbles of light in it.',
    rarity: 'Rare',
    requiresAttunement: false,
    isMagic: true,
  },
  ...
  },
  {
    ...
    requiresAttunement: true,
    isMagic: true,
    properties: ['3 charges (recharges dawn, all)'],
  },
  {
  ...
  },
  {
    ...
    category: 'Wondrous Item',
    description:
      'A Figurine of Wondrous Power is a statuette small enough to fit in a pocket. If you take a Magic action to throw the figurine to a point on the ground within 60 feet of yourself, the figurine becomes a living creature specified in the figurine’s description below. If the space where the creature would appear is occupied by other creatures or objects, or if there isn’t enough space for the creature, the figurine doesn’t become a creature. The creature is Friendly to you and your allies. It understands your languages, obeys your commands, and takes its turn immediately after you on your Initiative count. If you issue no commands, the creature defends itself but takes no other actions. The creature exists for a duration specific to each figurine. At the end of the duration, the creature reverts to its figurine form. It reverts to a figurine early if its creature form drops to 0 Hit Points or if you take a Magic action while touching the creature to make it revert to figurine form. When the creature becomes a figurine again, its property can’t be used again until a certain amount of time has passed, as specified in the figurine’s description. Bronze Griffon (Rare). This bronze statuette is of a griffon rampant. It can become a Griffon for up to 6 hours. Once it has been used, it can’t be used again until 5 days have passed. Ebony Fly (Rare). This ebony statuette, carved in the likeness of a horsefly, can become a Giant Fly (see the accompanying stat block) for up to 12 hours and can be ridden as a mount. Once it has been used, it can’t be used again until 2 days have passed. Giant Fly Large Beast, Unaligned AC 11\t\t Initiative +1 (11) HP 19 (3d10 + 3) Speed 30 ft., Fly 60 ft. MOD SAVE MOD SAVE MOD SA Str 14 +2 +2 Dex 13 +1 +1 Con 13 +1 +1 Int 2 −4 −4 Wis 10 +0 +0 Cha 3 −4 −4 Senses Darkvision 60 ft., Passive Perception 10 Languages None CR 0 (XP 0; PB +2) Golden Lions (Rare). These gold statuettes of lions are always created in pairs. You can use one figurine or both simultaneously. Each can become a Lion for up to 1 hour. Once a lion has been used, it can’t be used again until 7 days have passed. Ivory Goats (Rare). These ivory statuettes of goats are always created in sets of three. Each goat looks unique and functions differently from the others. Their properties are as follows: Goat of Terror. This figurine can become a Giant Goat for up to 3 hours. The goat can’t attack, but you can (harmlessly) remove its horns and use them as weapons. One horn becomes a +1 Lance, and the other becomes a +2 Longsword. Removing a horn requires a Magic action, and the weapons disappear and the horns return when the goat reverts to figurine form. While you ride the goat, any Hostile creature that starts its turn within a 30-foot Emanation originating from the goat must succeed on a DC 15 Wisdom saving throw or have the Frightened condition for 1 minute, until you are no longer riding the goat, or until the goat reverts to figurine form. The Frightened creature repeats the save at the end of each of its turns, ending the effect on itself on a success. Once it succeeds on the save, a creature is immune to this effect for the next 24 hours. Once the figurine has been used, it can’t be used again until 15 days have passed. Goat of Traveling. This figurine can become a Large goat with the same statistics as a Riding Horse. It has 24 charges, and each hour or portion thereof it spends in goat form costs 1 charge. While it has charges, you can use it as often as you wish. When it runs out of charges, it reverts to a figurine and can’t be used again until 7 days have passed, when it regains all expended charges. Goat of Travail. This figurine can become a Giant Goat for up to 3 hours. Once it has been used, it can’t be used again until 30 days have passed. Marble Elephant (Rare). This marble statuette resembles a trumpeting elephant. It can become an Elephant for up to 24 hours. Once it has been used, it can’t be used again until 7 days have passed. Obsidian Steed (Very Rare). This polished obsidian horse can become a Nightmare for up to 24 hours. The nightmare fights only to defend itself. Once it has been used, it can’t be used again until 5 days have passed. VE The figurine has a 10 percent chance each time you use it to ignore your orders, including a command to revert to figurine form. If you mount the nightmare while it is ignoring your orders, you and the nightmare are instantly transported to a random location on the plane of Hades, where the nightmare reverts to figurine form. Onyx Dog (Rare). This onyx statuette of a dog can become a Mastiff for up to 6 hours. The mastiff has an Intelligence of 8 and can speak Common. It also has Blindsight with a range of 60 feet. Once it has been used, it can’t be used again until 7 days have passed. Serpentine Owl (Rare). This serpentine statuette of an owl can become a Giant Owl for up to 8 hours. The owl can communicate telepathically with you at any range if you and it are on the same plane of existence. Once it has been used, it can’t be used again until 2 days have passed. Silver Raven (Uncommon). This silver statuette of a raven can become a Raven for up to 12 hours. Once it has been used, it can’t be used again until 2 days have passed. While in raven form, the figurine grants you the ability to cast Animal Messenger on it. Variants: Bronze Griffon (Rare): This bronze statuette is of a griffon rampant. It can become a Griffon for up to 6 hours. Once it has been used, it can’t be used again until 5 days have passed. | Ebony Fly (Rare): This ebony statuette, carved in the likeness of a horsefly, can become a Giant Fly (see the accompanying stat block) for up to 12 hours and can be ridden as a mount. Once it has been used, it can’t be used again until 2 days have passed. Giant Fly Large Beast, Unaligned AC 11 Initiative +1 (11) HP 19 (3d10 + 3) Speed 30 ft., Fly 60 ft. MOD SAVE MOD SAVE MOD SA Str 14 +2 +2 Dex 13 +1 +1 Con 13 +1 +1 Int 2 −4 −4 Wis 10 +0 +0 Cha 3 −4 −4 Senses Darkvision 60 ft., Passive Perception 10 Languages None CR 0 (XP 0; PB +2) | Golden Lions (Rare): These gold statuettes of lions are always created in pairs. You can use one figurine or both simultaneously. Each can become a Lion for up to 1 hour. Once a lion has been used, it can’t be used again until 7 days have passed. | Ivory Goats (Rare): These ivory statuettes of goats are always created in sets of three. Each goat looks unique and functions differently from the oth- ers. Their properties are as follows: Goat of Terror. This figurine can become a Giant Goat for up to 3 hours. The goat can’t attack, but you can (harmlessly) remove its horns and use them as weapons. One horn becomes a +1 Lance, and the other becomes a +2 Longsword. Removing a horn requires a Magic action, and the weapons disappear and the horns return when the goat reverts to figurine form. While you ride the goat, any Hostile creature that starts its turn within a 30-foot Emanation originating from the goat must succeed on a DC 15 Wisdom saving throw or have the Frightened condition for 1 minute, until you are no longer riding the goat, or until the goat reverts to figurine form. The Frightened creature repeats the save at the end of each of its turns, ending the effect on itself on a success. Once it succeeds on the save, a creature is immune to this effect for the next 24 hours. Once the figurine has been used, it can’t be used again until 15 days have passed. Goat of Traveling. This figurine can become a Large goat with the same statistics as a Riding Horse. It has 24 charges, and each hour or por- tion thereof it spends in goat form costs 1 charge. While it has charges, you can use it as often as you wish. When it runs out of charges, it reverts to a figurine and can’t be used again until 7 days have passed, when it regains all expended charges. Goat of Travail. This figurine can become a Giant Goat for up to 3 hours. Once it has been used, it can’t be used again until 30 days have passed. | Marble Elephant (Rare): This marble statuette resembles a trumpeting elephant. It can become an Elephant for up to 24 hours. Once it has been used, it can’t be used again until 7 days have passed. | Obsidian Steed (Very Rare): This polished ob- sidian horse can become a Nightmare for up to 24 hours. The nightmare fights only to defend itself. Once it has been used, it can’t be used again until 5 days have passed. VE The figurine has a 10 percent chance each time you use it to ignore your orders, including a com- mand to revert to figurine form. If you mount the nightmare while it is ignoring your orders, you and the nightmare are instantly transported to a random location on the plane of Hades, where the nightmare reverts to figurine form. | Onyx Dog (Rare): This onyx statuette of a dog can become a Mastiff for up to 6 hours. The mastiff has an Intelligence of 8 and can speak Common. It also has Blindsight with a range of 60 feet. Once it has been used, it can’t be used again until 7 days have passed. | Serpentine Owl (Rare): This serpentine statuette of an owl can become a Giant Owl for up to 8 hours. The owl can communicate telepathically with you at any range if you and it are on the same plane of ex- istence. Once it has been used, it can’t be used again until 2 days have passed. | Silver Raven (Uncommon): This silver statuette of a raven can become a Raven for up to 12 hours. Once it has been used, it can’t be used again until 2 days have passed. While in raven form, the figurine grants you the ability to cast Animal Messenger on it.',
    rarity: 'Varies',
    requiresAttunement: false,
    isMagic: true,
    properties: ['24 charges'],
  },
  {
    name: 'Flame Tongue',
    category: 'Weapon',
  ...
  },
  {
    ...
    requiresAttunement: true,
    isMagic: true,
    properties: ['Glaive, Greatsword, Longsword, Rapier, Scimitar, or Shortsword'],
  },
  {
  ...
  },
  {
    ...
    requiresAttunement: false,
    isMagic: true,
    properties: ['Studded Leather Armor'],
  },
  {
  ...
  },
  {
    ...
    requiresAttunement: true,
    isMagic: true,
    properties: ['Maul or Warhammer', '5 charges'],
  },
  {
  ...
  },
  {
    ...
    category: 'Wondrous Item',
    description:
      'This helm is set with 1d10 diamonds, 2d10 rubies, 3d10 fire opals, and 4d10 opals. Any gem pried from the helm crumbles to dust. When all the gems are removed or destroyed, the helm loses its magic. You gain the following benefits while wearing the helm. Diamond Light. As long as it has at least one diamond, the helm emits a 30-foot Emanation. l When at least one Undead is within that area, the n a Emanation is filled with Dim Light. Any Undead that starts its turn in that area takes 1d6 Radiant damage. Fire Opal Flames. As long as the helm has at least one fire opal, you can take a Magic action to cause one weapon you are holding to burst into flames. The flames emit Bright Light in a 10-foot radius and Dim Light for an additional 10 feet. The flames are harmless to you and the weapon. When you hit with an attack using the blazing weapon, the target takes a an extra 1d6 Fire damage. The flames last until you take a Bonus Action to extinguish them or until you drop or stow the weapon. Ruby Resistance. As long as the helm has at least one ruby, you have Resistance to Fire damage. Spells. You can cast one of the following spells (save DC 18), using one of the helm’s gems of the specified type as a component: Daylight (opal), Fireball (fire opal), Prismatic Spray (diamond), or Wall of Fire (ruby). The gem is destroyed when the spell is cast and disappears from the helm. Taking Fire Damage. Roll 1d20 if you are wearing the helm and take Fire damage as a result of failing a saving throw against a spell. On a roll of 1, the helm emits beams of light from its remaining gems and is then destroyed. Each creature within a 60- foot Emanation originating from you must succeed on a DC 17 Dexterity saving throw or be struck by a beam, taking Radiant damage equal to the number of gems in the helm.',
    rarity: 'Very Rare',
    requiresAttunement: true,
    isMagic: true,
  },
  ...
  },
  {
    ...
    requiresAttunement: true,
    isMagic: true,
    properties: ['Any Simple or Martial', 'Attunement: Paladin'],
  },
  {
  ...
  },
  {
    ...
    category: 'Wondrous Item',
    description:
      'You can take a Magic action to blow this horn. In response, warrior spirits from the plane of Ysgard appear in unoccupied spaces within 60 feet of you. Each spirit uses the Berserker stat block and returns to Ysgard after 1 hour or when it drops to 0 Hit Points. The spirits look like living, breathing warriors, and they have Immunity to the Charmed and Frightened conditions. Once you use the horn, it can’t be used again until 7 days have passed. Four types of Horn of Valhalla are known to exist, each made of a different metal. The horn’s type determines how many spirits it summons, as well as the requirement for its use. The GM chooses the horn’s type or determines it randomly by rolling on the following table. If you blow the horn without meeting its requirement, the summoned spirits attack you. If you meet the requirement, they are Friendly to you and your allies and follow your commands. 1d100 Horn Type Spirits Requirement 01–40 Silver 2 None 41–75 Brass 3 Proficiency with all Simple weapons 76–90 Bronze 4 Training with all Medium armor 91–00 Iron 5 Proficiency with all Martial weapons Variants: Horn of Valhalla (silver) (Rare): Summons 2d4+2 Berserkers. Usable by any class. | Horn of Valhalla (brass) (Rare): Summons 3d4+3 Berserkers. Requires proficiency with all Simple weapons. | Horn of Valhalla (bronze) (Very Rare): Summons 4d4+4 Berserkers. Requires proficiency with all Medium armor. | Horn of Valhalla (iron) (Legendary): Summons 5d4+5 Berserkers. Requires proficiency with all Martial weapons.',
    rarity: 'Very Rare',
    requiresAttunement: false,
    isMagic: true,
  },
  ...
  },
  {
    ...
    category: 'Wondrous Item',
    description:
      'This rusty iron sphere measures 3 inches in diame- ter and weighs 1 pound. You can take a Magic action to throw the sphere at a Huge or smaller creature you can see within 60 feet of yourself. As the sphere moves through the air, it opens into a tangle of metal bands. Make a ranged attack roll with an attack bonus equal to your Dexterity modifier plus your Profi- ciency Bonus. On a hit, the target has the Restrained condition until you take a Bonus Action to issue a command that releases it. Doing so or missing with the attack causes the bands to contract and become a sphere once more. A creature that can touch the bands, including the one Restrained, can take an action to make a DC 20 Strength (Athletics) check to break the iron bands. On a successful check, the item is destroyed, and the Restrained creature is freed. On a failed check, any further attempts made by that creature automati- cally fail until 24 hours have elapsed. Once the bands are used, they can’t be used again until the next dawn.',
    rarity: 'Rare',
    requiresAttunement: false,
    isMagic: true,
  },
  {
    ...
    category: 'Wondrous Item',
    description:
      'While holding this brass-stoppered iron flask, you can take a Magic action to target a creature that you can see within 60 feet of yourself. If the flask is empty and the target is native to a plane of exis- tence other than the one you’re on, the target must succeed on a DC 17 Wisdom saving throw or be trapped in the flask. If the target has been trapped by the flask before, it has Advantage on the save. Once trapped, a creature remains in the flask until released. The flask can hold only one creature at a time. A creature trapped in the flask doesn’t age and doesn’t need to breathe, eat, or drink. You can take a Magic action to remove the flask’s stopper and release the creature in the flask. The creature then obeys your commands for 1 hour, understanding those commands even if it doesn’t know the language in which the commands are given. If you issue no commands or give the crea- ture a command that is likely to result in its death or imprisonment, it defends itself but otherwise takes no actions. At the end of the duration, the creature acts in accordance with its normal disposi- tion and alignment. An Identify spell reveals if the flask contains a creature, but the only way to determine the type of creature is to open the flask. A newly discovered Iron Flask might already contain a creature chosen by the GM.',
    rarity: 'Legendary',
    requiresAttunement: false,
    isMagic: true,
  },
  ...
  },
  {
    ...
    requiresAttunement: true,
    isMagic: true,
    properties: ['Glaive, Greatsword, Longsword, Rapier, Scimitar, Sickle, or Shortsword'],
  },
  {
  ...
  },
  {
    ...
    requiresAttunement: true,
    isMagic: true,
    properties: ['Mace', '3 charges (recharges dawn, 1d3)'],
  },
  {
  ...
  },
  {
    ...
    requiresAttunement: true,
    isMagic: true,
    properties: ['5 charges (recharges dawn, 1d4)'],
  },
  {
  ...
  },
  {
    ...
    requiresAttunement: true,
    isMagic: true,
    properties: ['Attunement: Spellcaster'],
  },
  {
  ...
  },
  {
    ...
    category: 'Potion',
    description:
      'When you drink this potion, you gain the “reduce” effect of the Enlarge/Reduce spell for 1d4 hours (no Concentration required). The red in the potion’s liquid continuously con- tracts to a tiny bead and then expands to color the clear liquid around it. Shaking the bottle fails to in- terrupt this process.',
    rarity: 'Rare',
    requiresAttunement: false,
    isMagic: true,
  },
  ...
  },
  {
    ...
    category: 'Potion',
    description:
      'You regain Hit Points when you drink this potion. The number of Hit Points depends on the potion’s rarity, as shown in the table below. Whatever its potency, the potion’s red liquid glimmers when agitated. Potion HP Regained Rarity Potion of Healing 2d4 + 2 Common Potion of Healing 4d4 + 4 Uncommon (greater) Potion of Healing 8d4 + 8 Rare (superior) Potion of Healing 10d4 + 20 Very Rare (supreme) Variants: Potion of Healing (Common): You regain 2d4 + 2 Hit Points. | Potion of Healing (greater) (Uncommon): You regain 4d4 + 4 Hit Points. | Potion of Healing (superior) (Rare): You regain 8d4 + 8 Hit Points. | Potion of Healing (supreme) (Very Rare): You regain 10d4 + 20 Hit Points.',
    rarity: 'Varies',
    requiresAttunement: false,
    isMagic: true,
  },
  ...
  },
  {
    ...
    category: 'Potion',
    description:
      'When you drink this potion, you have Resistance to one type of damage for 1 hour. The GM chooses the type or determines it randomly by rolling on the following table. 1d10 Damage Type 1d10 Damage Type 1 Acid 6 Necrotic 2 Cold 7 Poison 3 Fire 8 Psychic 4 Force 9 Radiant 5 Lightning 10 Thunder',
    rarity: 'Uncommon',
    requiresAttunement: false,
    isMagic: true,
  },
  ...
  },
  {
    ...
    category: 'Ring',
    description:
      'While wearing this ring, you can take a Magic ac- tion to gain X-ray vision with a range of 30 feet for 1 minute. To you, solid objects within that radius appear transparent and don’t prevent light from passing through them. The vision can penetrate 1 e foot of stone, 1 inch of common metal, or up to 3 feet of wood or dirt. Thicker substances or a thin sheet of lead block the vision. Whenever you use the ring again before taking a Long Rest, you must succeed on a DC 15 Constitu- tion saving throw or gain 1 Exhaustion level.',
    rarity: 'Rare',
    requiresAttunement: true,
    isMagic: true,
  },
  ...
  },
  {
    ...
    category: 'Rod',
    description:
      'The rod has 5 charges. While you hold it, you can cast one of the following spells from it: Heal (ex- pends 1 charge) or Resurrection (expends 5 charges). The rod regains 1 expended charge daily at dawn. If you expend the last charge, roll 1d20. On a 1, the rod disappears in a harmless burst of radiance.',
    rarity: 'Legendary',
    requiresAttunement: true,
    isMagic: true,
    properties: ['5 charges (recharges dawn, 1)'],
  },
  {
    name: 'Rod of Rulership',
    category: 'Rod',
    description:
      'You can take a Magic action to present the rod and command obedience from each creature of your choice that you can see within 120 feet of your- self. Each target must succeed on a DC 15 Wisdom saving throw or have the Charmed condition for 8 hours. While Charmed in this way, the creature regards you as its trusted leader. If harmed by you or your allies or commanded to do something contrary to its nature, a target ceases to be Charmed in this way. Once used, this property can’t be used again until the next dawn.',
    rarity: 'Rare',
    requiresAttunement: true,
    isMagic: true,
  },
  ...
  },
  {
    ...
    category: 'Wondrous Item',
    description:
      'This beetle-shaped medallion provides three bene- fits while it is on your person. Defense. You gain a +1 bonus to Armor Class. Preservation. The scarab has 12 charges. If you fail a saving throw against a Necromancy spell or a harmful effect originating from an Undead, you can take a Reaction to expend 1 charge and turn the failed save into a successful one. The scarab crum- bles into powder and is destroyed when its last charge is expended. Spell Resistance. You have Advantage on saving throws against spells.',
    rarity: 'Legendary',
    requiresAttunement: true,
    isMagic: true,
    properties: ['12 charges'],
  },
  {
  ...
  },
  {
    ...
    category: 'Armor',
    description:
      'While holding this Shield, you have a bonus to Ar- mor Class determined by the Shield’s rarity, in addi- tion to the Shield’s normal bonus to AC. Rarity by variant: +1: Uncommon, +2: Rare, +3: Very Rare.',
    rarity: 'Varies',
    requiresAttunement: false,
    isMagic: true,
    properties: ['Shield'],
  ...
  },
  {
    ...
    category: 'Scroll',
    description:
      'A Spell Scroll bears the words of a single spell, writ- ten in a mystical cipher. If the spell is on your spell list, you can read the scroll and cast its spell with- out Material components. Otherwise, the scroll is unintelligible. Casting the spell by reading the scroll requires the spell’s normal casting time. Once the spell is cast, the scroll crumbles to dust. If the cast- ing is interrupted, the scroll isn’t lost. If the spell is on your spell list but of a higher lev than you can normally cast, you make an ability check using your spellcasting ability to determine whether you cast the spell. The DC equals 10 plus the spell’s level. On a failed check, the spell disap- pears from the scroll with no other effect. The level of the spell on the scroll determines the spell’s saving throw DC and attack bonus, as well as the scroll’s rarity, as shown in the following table. Spell Level Rarity Save DC Attack Bonus Cantrip Common 13 +5 1 Common 13 +5 2 Uncommon 13 +5 3 Uncommon 15 +7 Spell Level Rarity Save DC Attack Bonus 4 Rare 15 +7 5 Rare 17 +9 6 Very Rare 17 +9 7 Very Rare 18 +10 8 Very Rare 18 +10 9 Legendary 19 +11 Copying a Scroll into a Spellbook. A Wizard spell on a Spell Scroll can be copied into a spellbook. When a spell is copied in this way, the copier must succeed on an Intelligence (Arcana) check with a DC equal to 10 plus the spell’s level. On a successful check, the spell is copied. Whether the check suc- ceeds or fails, the Spell Scroll is destroyed. Variants: Spell Scroll (cantrip) (Common): Spell save DC 13, spell attack bonus +5. | Spell Scroll (level 1) (Common): Spell save DC 13, spell attack bonus +5. | Spell Scroll (level 2) (Uncommon): Spell save DC 13, spell attack bonus +5. | Spell Scroll (level 3) (Uncommon): Spell save DC 15, spell attack bonus +7. | Spell Scroll (level 4) (Rare): Spell save DC 15, spell attack bonus +7. | Spell Scroll (level 5) (Rare): Spell save DC 17, spell attack bonus +9. | Spell Scroll (level 6) (Very Rare): Spell save DC 17, spell attack bonus +9. | Spell Scroll (level 7) (Very Rare): Spell save DC 18, spell attack bonus +10. | Spell Scroll (level 8) (Very Rare): Spell save DC 18, spell attack bonus +10. | Spell Scroll (level 9) (Legendary): Spell save DC 19, spell attack bonus +11.',
    rarity: 'Varies',
    requiresAttunement: false,
    isMagic: true,
  },
  ...
  },
  {
    ...
    requiresAttunement: true,
    isMagic: true,
    properties: ['Attunement: Bard, Cleric, Druid, Sorcerer, Warlock, or Wizard', '10 charges'],
  },
  {
    name: 'Staff of Fire',
    category: 'Staff',
    description:
      'You have Resistance to Fire damage while you hold this staff. Spells. The staff has 10 charges. While holding the staff, you can cast one of the spells on the following table from it, using your spell save DC. The table indicates how many charges you must expend to cast the spell. Charge Charge Spell Cost Spell Cost Burning Hands 1 Wall of Fire 4 Fireball 3 Regaining Charges. The staff regains 1d6 + 4 expended charges daily at dawn. If you expend the last charge, roll 1d20. On a 1, the staff crumbles into cinders and is destroyed. Spells: Fireball (3 charges), Burning Hands (1 charges), Wall of Fire (4 charges).',
    rarity: 'Very Rare',
    requiresAttunement: true,
    isMagic: true,
    properties: [
      'Attunement: Druid, Sorcerer, Warlock, or Wizard',
      '10 charges (recharges dawn, 1d6+4)',
    ],
  },
  {
    name: 'Staff of Frost',
    category: 'Staff',
    description:
      'You have Resistance to Cold damage while you hold this staff. Spells. The staff has 10 charges. While holding the staff, you can cast one of the spells on the following table from it, using your spell save DC. The table indicates how many charges you must expend to cast the spell. Charge Charge Spell Cost Spell Cost Cone of Cold 5 Ice Storm 4 Fog Cloud 1 Wall of Ice 4 Regaining Charges. The staff regains 1d6 + 4 expended charges daily at dawn. If you expend the last charge, roll 1d20. On a 1, the staff turns to water and is destroyed. Spells: Cone of Cold (5 charges), Ice Storm (4 charges), Fog Cloud (1 charges), Wall of Ice (4 charges).',
    rarity: 'Very Rare',
    requiresAttunement: true,
    isMagic: true,
    properties: ['Attunement: Druid, Sorcerer, Warlock, or Wizard', '10 charges'],
  },
  {
    name: 'Staff of Healing',
    category: 'Staff',
    description:
      'This staff has 10 charges. While holding the staff, you can cast one of the spells on the following table from it, using your spellcasting ability modifier. The table indicates how many charges you must expend to cast the spell. Spell Charge Cost Cure Wounds 1 charge per spell level (maximum 4 for a level 4 spell) Lesser Restoration 2 Mass Cure Wounds 5 Regaining Charges. The staff regains 1d6 + 4 expended charges daily at dawn. If you expend the last charge, roll 1d20. On a 1, the staff vanishes in a flash of light, lost forever. Spells: Lesser Restoration (2 charges), Mass Cure Wounds (5 charges), Cure Wounds (1 charges).',
    rarity: 'Rare',
    requiresAttunement: true,
    isMagic: true,
    properties: ['Attunement: Bard, Cleric, or Druid', '10 charges (recharges dawn, 1d6+4)'],
  },
  {
    name: 'Staff of Power',
    category: 'Staff',
    description:
      'This staff has 20 charges and can be wielded as a magic Quarterstaff that grants a +2 bonus to attack rolls and damage rolls made with it. While holding it, you gain a +2 bonus to Armor Class, saving throws, and spell attack rolls. Spells. While holding the staff, you can cast one of the spells on the following table from it, using your spell save DC. The table indicates how many charges you must expend to cast the spell. Charge Spell Cost Cone of Cold 5 Fireball (level 5 version) 5 Globe of Invulnerability 6 Hold Monster 5 Levitate 2 Lightning Bolt (level 5 version) 5 Magic Missile 1 Ray of Enfeeblement 1 Wall of Force 5 Regaining Charges. The staff regains 2d8 + 4 expended charges daily at dawn. If you expend the last charge, roll 1d20. On a 1, the staff retains its +2 bonus to attack rolls and damage rolls but loses all other properties. On a 20, the staff regains 1d8 + 2 charges. Retributive Strike. You can take a Magic action to break the staff over your knee or against a solid surface. The staff is destroyed and releases its magic in an explosion that fills a 30-foot Emanation originating from itself. You have a 50 percent chance to instantly travel to a random plane of existence, avoiding the explosion. If you fail to avoid the effect, you take Force damage equal to 16 times the number of charges in the staff. Each other creature in the area makes a DC 17 Dexterity saving throw. On a failed save, a creature takes Force damage equal to 4 times the number of charges in the staff. On a successful save, a creature takes half as much damage. Spells: Cone of Cold (5 charges), Fireball (level 5 version) (5 charges), Globe of Invulnerability (6 charges), Hold Monster (5 charges), Levitate (2 charges), Lightning Bolt (level 5 version) (5 charges), Magic Missile (1 charges), Ray of Enfeeblement (1 charges), Wall of Force (5 charges).',
    rarity: 'Very Rare',
    requiresAttunement: true,
    isMagic: true,
    properties: ['Attunement: Sorcerer, Warlock, or Wizard', '20 charges (recharges dawn, 2d8+4)'],
  },
  {
  ...
  },
  {
    ...
    category: 'Staff',
    description:
      'This staff has 50 charges and can be wielded as a magic Quarterstaff that grants a +2 bonus to attack rolls and damage rolls made with it. While you hold it, you gain a +2 bonus to spell attack rolls. Spell Absorption. While holding the staff, you have Advantage on saving throws against spells. In addition, you can take a Reaction when another creature casts a spell that targets only you. If you do, the staff absorbs the magic of the spell, canceling its effect and gaining a number of charges equal to the absorbed spell’s level. However, if doing so brings the staff’s total number of charges above 50, the staff explodes as if you activated its Retributive Strike (see below). Spells. While holding the staff, you can cast one of the spells on the following table from it, using your spell save DC. The table indicates how many charges you must expend to cast the spell. Charge Spell Cost Arcane Lock 0 Conjure Elemental 7 Detect Magic 0 Dispel Magic 3 Enlarge/Reduce 0 Fireball (level 7 version) 7 Flaming Sphere 2 Ice Storm 4 Invisibility 2 Knock 2 Light 0 Lightning Bolt (level 7 version) 7 Charge Spell Cost Mage Hand 0 Passwall 5 Plane Shift 7 Protection from Evil and Good 0 Telekinesis 5 Wall of Fire 4 Web 2 Regaining Charges. The staff regains 4d6 + 2 expended charges daily at dawn. If you expend the last charge, roll 1d20. On a 20, the staff regains 1d12 + 1 charges. Retributive Strike. You can take a Magic action to break the staff over your knee or against a solid surface. The staff is destroyed and releases its magic in an explosion that fills a 30-foot Emanation originat- ing from itself. You have a 50 percent chance to instantly travel to a random plane of existence, avoiding the explosion. If you fail to avoid the effect, you take Force damage equal to 16 times the number of charges in the staff. Each other creature in the area makes a DC 17 Dexterity saving throw. On a failed save, a creature takes Force damage equal to 6 times the number of charges in the staff. On a successful save, a creature takes half as much damage. Spells: Arcane Lock, Conjure Elemental (7 charges), Detect Magic, Dispel Magic (3 charges), Enlarge/Reduce, Fireball (level 7 version) (7 charges), Flaming Sphere (2 charges), Ice Storm (4 charges), Invisibility (2 charges), Knock (2 charges), Light, Lightning Bolt (level 7 version) (7 charges), Mage Hand, Passwall (5 charges), Plane Shift (7 charges), Protection from Evil and Good, Telekinesis (5 charges), Wall of Fire (4 charges), Web (2 charges).',
    rarity: 'Legendary',
    requiresAttunement: true,
    isMagic: true,
    properties: ['Attunement: Sorcerer, Warlock, or Wizard', '50 charges'],
  },
  {
  ...
  },
  {
    ...
    requiresAttunement: true,
    isMagic: true,
    properties: ['Glaive, Greatsword, Longsword, or Scimitar'],
  },
  {
  ...
  },
  {
    ...
    requiresAttunement: true,
    isMagic: true,
    properties: ['Trident', '3 charges (recharges dawn, 1d3)'],
  },
  {
  ...
  },
  {
    ...
    category: 'Wand',
    description:
      'This wand has 7 charges. Spells. While holding the wand, you can cast one of the spells (save DC 15) on the following table from it. The table indicates how many charges you must expend to cast the spell. Charge Spell Cost Command (“flee” or “grovel” only) 1 Fear (60-foot Cone) 3 Regaining Charges. The wand regains 1d6 + 1 expended charges daily at dawn. If you expend the wand’s last charge, roll 1d20. On a 1, the wand crumbles into ashes and is destroyed.',
    rarity: 'Rare',
    requiresAttunement: true,
    isMagic: true,
    properties: ['7 charges (recharges dawn, 1d6+ 1)'],
  },
  {
    ...
    requiresAttunement: true,
    isMagic: true,
    properties: ['Attunement: Spellcaster', '7 charges (recharges dawn, 1d6+ 1)'],
  },
  {
  ...
  },
  {
    ...
    category: 'Wand',
    description:
      'This wand has 7 charges. While holding it, you can take a Magic action to expend 1 charge to cause a thin blue ray to streak from the tip toward a crea- ture you can see within 60 feet of yourself. The target must succeed on a DC 15 Constitution saving throw or have the Paralyzed condition for 1 minute. At the end of each of the target’s turns, it repeats the save, ending the effect on itself on a success. Regaining Charges. The wand regains 1d6 + 1 expended charges daily at dawn. If you expend the wand’s last charge, roll 1d20. On a 1, the wand crumbles into ashes and is destroyed.',
    rarity: 'Rare',
    requiresAttunement: true,
    isMagic: true,
    properties: ['Attunement: Spellcaster', '7 charges (recharges dawn, 1d6+ 1)'],
  ...
  },
  {
    ...
    category: 'Wand',
    description:
      'This wand has 3 charges and regains 1d3 expended charges daily at dawn. While holding it, you can take a Magic action to expend 1 charge, and if a se- cret door or trap is within 60 feet of you, the wand pulses and points at the one nearest to you.',
    rarity: 'Uncommon',
    requiresAttunement: false,
    isMagic: true,
    properties: ['3 charges (recharges dawn, 1d3)'],
  },
  {
    ...
    category: 'Wand',
    description:
      'While holding this wand, you gain a bonus to spell attack rolls determined by the wand’s rarity. In addition, you ignore Half Cover when making a spell attack roll. Rarity by variant: +1: Uncommon, +2: Rare, +3: Very Rare.',
    rarity: 'Varies',
    requiresAttunement: true,
    isMagic: true,
    properties: ['Attunement: Spellcaster'],
  ...
  },
  {
    ...
    category: 'Weapon',
    description:
      'You have a bonus to attack rolls and damage rolls made with this magic weapon. The bonus is determined by the weapon’s rarity. Rarity by variant: +1: Uncommon, +2: Rare, +3: Very Rare.',
    rarity: 'Varies',
    requiresAttunement: false,
    isMagic: true,
    properties: ['Any Simple or Martial'],
